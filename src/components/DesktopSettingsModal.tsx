                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                          <div className="mb-4">
                            <div className="text-white font-medium mb-1">背景暗化度</div>
                            <div className="text-white/60 text-sm">独立降低壁纸亮度，让桌面歌词与卡片更清晰</div>
                          </div>
                          ...
                          <div className="space-y-3">
                            <div className="flex items-center gap-4">
                              <input
                                ...
                                max="70"
                                value={backgroundDim}
                                onChange={(e) => handleBackgroundDimChange(parseInt(e.target.value))}
                                className="flex-1 h-2 rounded-lg appearance-none cursor-pointer"
                                style={{
                                  background: `linear-gradient(to right, #8b5cf6 0%, #8b5cf6 ${(backgroundDim / 70) * 100}%, rgba(255,255,255,0.2) ${(backgroundDim / 70) * 100}%, rgba(255,255,255,0.2) 100%)`
                                }}
                              />
                              <div className="text-white font-medium text-sm w-12 text-right">{backgroundDim}%</div>
                            </div>
                            <div className="text-white/40 text-xs">
                              当前暗化度：{backgroundDim === 0 ? '不暗化' : backgroundDim < 20 ? '轻微' : backgroundDim < 45 ? '中等' : '较强'}
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <h3 className="text-lg font-semibold text-white">背景效果</h3>
                        </div>
                        
                        {/* 背景模糊度 */}
                        <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                          <div className="mb-4">
                            <div className="text-white font-medium mb-1">背景模糊度</div>
                            <div className="text-white/60 text-sm">调整桌面背景的模糊程度</div>
                          </div>
                          ...
                          <div className="space-y-3">
                            <div className="flex items-center gap-4">
                              <input
                                ...
                                onChange={(e) => handleBackgroundBlurChange(parseInt(e.target.value))}
                                className="flex-1 h-2 rounded-lg appearance-none cursor-pointer"
                                style={{
                                  background: `linear-gradient(to right, #8b5cf6 0%, #8b5cf6 ${(backgroundBlur / 20) * 100}%, rgba(255,255,255,0.2) ${(backgroundBlur / 20) * 100}%, rgba(255,255,255,0.2) 100%)`
                                }}
                              />
                              <div className="text-white font-medium text-sm w-12 text-right">{backgroundBlur}px</div>
                            </div>
                            <div className="text-white/40 text-xs">
                              当前模糊度：{backgroundBlur === 0 ? '无模糊' : backgroundBlur < 5 ? '轻微' : backgroundBlur < 10 ? '中等' : backgroundBlur < 15 ? '较强' : '非常强'}
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="bg-white/5 rounded-xl p-4 border border-white/10 mb-3">
                          <div className="flex items-center justify-between mb-3">
                            <div>
                              <div className="text-white font-medium mb-1">GPU 硬件加速</div>
                              <div className="text-white/60 text-sm">
                                启用后使用显卡加速渲染动画，提升流畅度
                              </div>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
                              <input
                                ...
                                className="sr-only peer"
                              />
                              <div className={`w-11 h-6 bg-white/20 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all`} style={{ backgroundColor: gpuAcceleration ? '#10b981' : '' }}></div>
                            </label>
                          </div>
                          <div className="text-white/40 text-xs mt-3 p-3 rounded-lg bg-white/5">
                            ⚠️ 如遇到以下问题请关闭：动画闪烁、画面撕裂、黑屏、显卡风扇高速运转、系统卡顿
                          </div>
                        </div>
                        ...
                        <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                          <div className="mb-3">
                            <div className="text-white font-medium mb-1">歌词渲染模式</div>
                            <div className="text-white/60 text-sm">
                              根据设备性能选择合适的歌词渲染方案
                            </div>
                          </div>
                          ...
                          <div className="space-y-2 mb-3">
                            <button
                              onClick={() => handleLyricsComponentModeChange('virtualized')}
                              className={`w-full flex items-center gap-3 p-3 rounded-lg transition-all border-2`}
                              style={{
                                borderColor: lyricsComponentMode === 'virtualized' ? '#10b981' : 'transparent',
                                backgroundColor: lyricsComponentMode === 'virtualized' 
                                  ? 'rgba(16,185,129,0.2)'
                                  : 'rgba(255,255,255,0.05)'
                              }}
                            >
                              <div 
                                ...
                                style={{
                                  borderColor: lyricsComponentMode === 'virtualized' ? '#10b981' : 'rgba(255,255,255,0.4)',
                                  backgroundColor: lyricsComponentMode === 'virtualized' ? '#10b981' : 'transparent'
                                }}
                              >
                                {lyricsComponentMode === 'virtualized' && (
                                  <div className="w-2 h-2 rounded-full bg-white"></div>
                                )}
                              </div>
                              <div className="flex-1 text-left">
                                <div className="text-white text-sm font-medium">虚拟滚动模式（推荐）</div>
                                <div className="text-white/40 text-xs">内存占用低，适合长歌词</div>
                              </div>
                            </button>
                            
                            <button
                              onClick={() => handleLyricsComponentModeChange('standard')}
                              className={`w-full flex items-center gap-3 p-3 rounded-lg transition-all border-2`}
                              style={{
                                borderColor: lyricsComponentMode === 'standard' ? '#10b981' : 'transparent',
                                backgroundColor: lyricsComponentMode === 'standard' 
                                  ? 'rgba(16,185,129,0.2)'
                                  : 'rgba(255,255,255,0.05)'
                              }}
                            >
                              <div 
                                className={`w-5 h-5 rounded-full border-2 flex items-center justify-center flex-shrink-0`}
                                style={{
                                  borderColor: lyricsComponentMode === 'standard' ? '#10b981' : 'rgba(255,255,255,0.4)',
                                  backgroundColor: lyricsComponentMode === 'standard' ? '#10b981' : 'transparent'
                                }}
                              >
                                {lyricsComponentMode === 'standard' && (
                                  <div className="w-2 h-2 rounded-full bg-white"></div>
                                )}
                              </div>
                              <div className="flex-1 text-left">
                                <div className="text-white text-sm font-medium">标准模式</div>
                                <div className="text-white/40 text-xs">完整渲染，动画更流畅</div>
                              </div>
                            </button>
                          </div>
                          
                          <div className="text-white/40 text-xs mt-3 p-3 rounded-lg bg-white/5">
                            💡 如果歌词滚动卡顿，可尝试切换到另一个模式
                          </div>
                        </div>
